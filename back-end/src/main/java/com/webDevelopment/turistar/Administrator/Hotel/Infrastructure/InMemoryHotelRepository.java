...
public class InMemoryHotelRepository implements HotelRepository {
    private List<Hotel> hotels = new ArrayList<>(){{
        ...
        , new ArrayList<>(){{
            add(new HotelPhoto("https://s16847.pcdn.co/wp-content/uploads/2019/09/Galeria1.jpg"));
            add(new HotelPhoto("https://cf.bstatic.com/images/hotel/max1024x768/253/253797511.jpg"));
        }}));
    }};
    @Override
