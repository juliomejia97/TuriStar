...
public class TourSpotDetail {
    ...
    public TourSpotDetail(String tourSpotId, String tourSpotName, Double latitude, Double longitude, String description) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(tourSpotId, tourSpotName, latitude, longitude, description);
    }
