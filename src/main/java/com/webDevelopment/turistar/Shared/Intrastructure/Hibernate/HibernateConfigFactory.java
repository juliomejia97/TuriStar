...
public class HibernateConfigFactory {
    ...
    public LocalSessionFactoryBean sessionFactory(){
        ...
        FileSystemResource resource4 = new FileSystemResource("./src/main/java/com/webDevelopment/turistar/Tour/TourBooking/Infrastructure/Hibernate/TourBooking.hbm.xml");
