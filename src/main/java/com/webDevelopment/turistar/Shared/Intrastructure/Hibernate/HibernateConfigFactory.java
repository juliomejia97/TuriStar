...
public class HibernateConfigFactory {
    ...
    public LocalSessionFactoryBean sessionFactory(){
        ...
        FileSystemResource resource4 = new FileSystemResource("./src/main/java/com/webDevelopment/turistar/Hotel/HotelPlanBooking/Infrastructure/Hibernate/HotelPlanBooking.hbm.xml");
