package com.webDevelopment.turistar.HotelPlanBooking.Infrastructure;
...
public class InMemoryHotelPlanBookingRepository implements HotelPlanBookingRepository {
    ...
    private HotelPlanBooking hotelPlanBooking1 = new HotelPlanBooking(new HotelPlanBookingId("a0619482-a621-11eb-bcbc-0242ac130002"),new HotelPlanBookingInitDate(LocalDate.of(2022, 1, 8)),new HotelPlanBookingEndDate(LocalDate.of(2022, 1, 20)));
    private HotelPlanBooking hotelPlanBooking2 = new HotelPlanBooking(new HotelPlanBookingId("a06197e8-a621-11eb-bcbc-0242ac130002"),new HotelPlanBookingInitDate(LocalDate.of(2022, 1, 8)),new HotelPlanBookingEndDate(LocalDate.of(2022, 1, 20)));
    private HotelPlanBooking hotelPlanBooking3 = new HotelPlanBooking(new HotelPlanBookingId("a06198e2-a621-11eb-bcbc-0242ac130002"),new HotelPlanBookingInitDate(LocalDate.of(2022, 1, 8)),new HotelPlanBookingEndDate(LocalDate.of(2022, 1, 20)));
