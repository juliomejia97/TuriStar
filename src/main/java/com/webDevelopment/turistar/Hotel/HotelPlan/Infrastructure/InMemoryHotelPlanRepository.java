...
public class InMemoryHotelPlanRepository implements HotelPlanRepository {
    ...
    private HotelPlan hotelPlan1 = new HotelPlan(new HotelPlanId("a0619482-a621-11eb-bcbc-0242ac130002"), new HotelPlanPrice(400000),new HotelPlanDescription("El mejor toursito"),new HotelPlanPeopleNumber(2));
    private HotelPlan hotelPlan2 = new HotelPlan(new HotelPlanId("a06197e8-a621-11eb-bcbc-0242ac130002"), new HotelPlanPrice(200000),new HotelPlanDescription("El peor tour de colombia"),new HotelPlanPeopleNumber(3));
    private HotelPlan hotelPlan3 = new HotelPlan(new HotelPlanId("a06198e2-a621-11eb-bcbc-0242ac130002"), new HotelPlanPrice(60000),new HotelPlanDescription("El mas o menos tour de colombia"),new HotelPlanPeopleNumber(4));
